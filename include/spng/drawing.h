...
#ifndef _SPNG_DRAWING_H
#define _SPNG_DRAWING_H
...
#define SPNG_CHARACTER_HEIGHT 16
#define SPNG_CHARACTER_WIDTH 9
 ...
 * @return int returns SPNG_ERROR and set SPNG_ERRNO on error, SPNG_OK on success
 */
 ...
 * @return @return int returns SPNG_ERROR and set SPNG_ERRNO on error, SPNG_OK on success
 */
