 ...
 */
SPNG_IMPORT int draw_circle(image_s* img, int32_t x, int32_t y, int32_t r, uint64_t colour);
 ...
 * @return int returns 0 on success, -1 otherwise
 */
SPNG_IMPORT int draw_ring(image_s* img, int32_t x, int32_t y, int32_t ro, int32_t ri, uint64_t colour);
 ...
 * @return int returns 0 on success, -1 otherwise
 */
SPNG_IMPORT int draw_square(image_s* img, int32_t x, int32_t y, int32_t s, uint64_t colour);
 ...
 * @return int returns 0 on success, -1 otherwise
 */
SPNG_IMPORT int draw_rectangle(image_s* img, int32_t x0, int32_t y0, int32_t x1, int32_t y1, uint64_t colour);
 ...
 * @return int returns 0 on success, -1 otherwise
 */
SPNG_IMPORT int draw_line(image_s* img, int32_t x0, int32_t y0, int32_t x1, int32_t y1, uint32_t width, uint64_t colour);
 ...
 * @return int returns 0 on success, -1 otherwise
 */
SPNG_IMPORT int printc(image_s* img, int character, int32_t x, int32_t y, uint32_t size, uint64_t colour);
 ...
 * @return int returns 0 on success, -1 otherwise
 */
SPNG_IMPORT int prints(image_s* img, const char* str, int32_t x, int32_t y, uint32_t size, uint64_t colour);
